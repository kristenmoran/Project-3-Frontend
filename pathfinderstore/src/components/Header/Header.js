			...
			<header>
				<Navbar className='header-container'>
					...
					<DropdownButton
						...
						title='Categories'>
						<Link to='/adventuring' className='dropdown-item'>
							Adventuring Gear
						</Link>
						<Link className='dropdown-item' to='/food_drink'>
							Food and Drink
						</Link>
						<Link className='dropdown-item' to='/armor_shield'>
							Armor and Shield
						</Link>
						<Link className='dropdown-item' to='/weapons'>
							Weapons
						</Link>
						<Link className='dropdown-item' to='/alchemical'>
							Alchemical Items
						</Link>
						...
						<Link className='dropdown-item' to='/writing'>
							Books, Paper and Writing Supplies
						</Link>
					</DropdownButton>
				</Navbar>
			</header>
